...
// TODO: Improve needed
KernelArgDesc_t := #partial #sparse[KernelArg_t]^runtime.Type_Info {
	...
	.UCHARN          = type_info_of(u8),
	.SHORTN          = type_info_of(i16),
	.UNSIGNED_SHORTN = type_info_of(u16),
	.USHORTN         = type_info_of(u16),
	.INTN            = type_info_of(i32),
	.UNSIGNED_INTN   = type_info_of(u32),
	.UINTN           = type_info_of(u32),
	.LONGN           = type_info_of(i64),
	.UNSIGNED_LONGN  = type_info_of(u64),
	.ULONGN          = type_info_of(u64),
